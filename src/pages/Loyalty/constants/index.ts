import Loyalty_card1 from "@/assets/images/Loyalty_card1.png";
import Loyalty_card2 from "@/assets/images/Loyalty_card2.png";
import Loyalty_card3 from "@/assets/images/Loyalty_card3.png";
...
export const accordionData = [
    {
      ...
      answer: 'Joining the loyalty programme is very easy! You need to register on our website and make your first rental. After that you will automatically receive a Traveler\'s Loyalty Card.',
    },
    {
      id: 2,
      question: 'What are the benefits of the Traveler\'s Card?',
      answer: 'With a Traveler\'s Card, you get a discount on your first rental, access to exclusive offers and priority customer support.',
    },
    {
      id: 3,
      question: 'Can I use the bonuses all at once?',
      answer: 'Yes, your rewards are activated as soon as you receive your card and can be used on your next booking.',
    },
    {
      id: 4,
      question: 'How do I switch to Explorer\'s or Globetrotter\'s Cards?',
      answer: 'Your card level increases automatically when you reach a certain number of bookings. The more you travel, the higher your level.',
    },
    {
      id: 5,
      question: 'Do my bonuses have an expiry date?',
      answer: 'No, your bonuses have no expiry date and will stay with you as long as you are a member of the loyalty programme.',
    },
];
